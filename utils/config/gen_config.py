...
def add_options():
    ...
    # Dataset
    parser.add_argument("--train_data", default="resources/sample/sample_gen_train.csv", type=str, help="상대 경로를 적어주세요!")
    parser.add_argument("--test_data", default="resources/sample/sample_gen_test.csv", type=str, help="상대 경로를 적어주세요!")
    ...
    # Model
    parser.add_argument("--pretrained_model", default="google/gemma-2-2b-it", type=str, help="7b도 시험해보면 좋을 것 같아요!")
    ...
    parser.add_argument("--max_length", default=512, type=int, help="텍스트 길이에 따라 조정해야할 것 같아요.")
    ...
    parser.add_argument("--model_checkpoint_dir", default="resources/log/sample", type=str,
