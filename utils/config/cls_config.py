...
def add_options():
    ...
    parser.add_argument("--target_name", default="topic", type=str, 
                        choices=["topic", "keyword", "speech_act"], help="topic과 keywrod는 같은 파일이고, speach_act는 또 다른 파일입니다.")
    ...
    parser.add_argument("--use_quantization", action="store_true", help="양자화 사용 여부")
    ...
    parser.add_argument("--batch_size", default=4, type=int, help="학습할 때 병렬처리 최적화를 위해서 8, 16, 32 등 2의 제곱으로 지정해주세요")
