...
def training_loop(config) -> TransformerModule:
    ...
    wandb_logger = WandbLogger(name=f"{config.pretrained_model}_{config.target_name}_{config.exp_name}", project="nlp", save_dir=config.model_checkpoint_dir, log_model=True)
